...
public class MyDATA {
    ...
    static String[] drawableArrays = {"gs://recyclerview-88e97.appspot.com/download.png","gs://recyclerview-88e97.appspot.com/transparency_demonstration_1.png"};

    static Integer[] _id = {0,1,2,3,4,5,6};
